...
caught in premiere-pro-theme, the mod this one was forked from, written down so
the next pass looks for them before the reviewer does. The D3D12 layer those
rounds mention stayed behind in that mod; the lessons did not.
...
- Does anything the mod handed After Effects point **into the mod's image**? A
